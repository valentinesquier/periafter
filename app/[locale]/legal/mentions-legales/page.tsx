...
export default function MentionsLegalesPage() {
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <h1 className="font-serif text-4xl font-semibold text-periafter-anthracite mt-6 mb-8">
        Mentions légales
      </h1>
      <div className="prose-periafter">
        <p>
          <strong>Éditeur du site</strong><br />
          Le site periafter.com est édité par esq.group, EI au capital de 1 000 €, immatriculée
        ...
        <p>
          ...
          Les informations diffusées sur Periafter constituent un témoignage personnel
