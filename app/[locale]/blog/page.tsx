  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        ...
        <h1 className="font-serif text-4xl lg:text-5xl font-semibold text-periafter-anthracite mt-6 mb-4">
          Blog
        </h1>
        ...
        {articles.length > 0 ? (
            ...
            {categories.length > 0 && (
              <div className="flex flex-wrap gap-2 mb-10">
                {categories.map((cat) => (
                  <span
                    key={cat}
                    className="px-3 py-1 rounded-full bg-periafter-vert/10 text-periafter-vert font-sans text-xs uppercase tracking-wider"
                  >
                    {cat}
                  </span>
                ))}
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {articles.map((article) => (
                ...
                >
                  ...
                  <h2 className="font-serif text-lg font-semibold text-periafter-anthracite mb-2 group-hover:text-periafter-vert transition-colors">
                    {article.title}
                  </h2>
          ...
          <div className="text-center py-16 border border-periafter-anthracite/10 rounded-lg bg-periafter-anthracite/3">
